...
/* ƒелит изображение на 4 региона и выбирает тот, у кого больше средн€€ €ркость
...
// ¬ычисл€ет точку атмосферного света методом QuadTree division
cv::Vec3b get_atm_light(const cv::Mat& img, double stopdiv_size, int minfilt_size) {
	...
	// ”часток изображени€ с максимальной €ркостью атмосферного света
